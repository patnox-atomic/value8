...
public class Product 
{
	  ...
	  public Product(Long id, Long product_id, Long quantity, Boolean is_fullfilled, LocalDate date_ordered, LocalDate date_fullfilled, Boolean is_deleted) 
	  {
		    this.id = id;
	  ...
	  public Product(Long product_id, Long quantity, Boolean is_fullfilled, LocalDate date_ordered, LocalDate date_fullfilled, Boolean is_deleted) 
	  {
		    this.product_id = product_id;
		    this.quantity = quantity;
		    this.is_fullfilled = is_fullfilled;
